...
function KeepworkServiceWorld:GetWorldsList(callback)
    ...
    LOG.std("in keepworkservice getWorldsList")
...
function KeepworkServiceWorld:MergeRemoteWorldList(localWorlds, callback)
    ...
    --codepku--
    codepkuWorlds = {}
    KeepworkProjectsApi:GetProject(10990, function (data, err)  
        local codepkuWorld = data.world
        codepkuWorld['user'] = data['user']
        codepkuWorld['createdAt'] = data['createdAt']
        codepkuWorld['updatedAt'] = data['updatedAt']
            
        codepkuWorlds[1] = codepkuWorld
    end)
    KeepworkProjectsApi:GetProject(10933, function (data, err)     
        local codepkuWorld = data.world
        codepkuWorld['user'] = data['user']
        codepkuWorld['createdAt'] = data['createdAt']
        codepkuWorld['updatedAt'] = data['updatedAt']    
        codepkuWorlds[2] = codepkuWorld
        ...
        local remoteWorldsList = codepkuWorlds
