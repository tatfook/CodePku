...
Use Lib:
-------------------------------------------------------
NPL.load("(gl)Mod/CodePku/service/FileDownloader/FileDownloader.lua")
local FileDownloader = commonlib.inherit(nil, commonlib.gettable("Mod.CodePku.service.FileDownloader.FileDownloader"))
-------------------------------------------------------
]]
